        ...
        <table className="w-full">
          ...
          <thead>
            <tr>
              ...
              <th scope="col">
                <div
                   className=" box-content m-auto h-12 w-34 p-4 rounded-xl
                 m4"
          ...
          <tbody className="space-y-6 text-center divide-y dark:divide-gray-300">
            ...
            <tr>
              <th scope="row" className="text-left">
                <h3 className="py-3 font-medium text-gray-600">Unlimited Transactions</h3>
              </th>
              <td>
                <div>
                  <svg
            ...
            <tr>
              <th scope="row" className="text-left">
                <h3 className="py-3 font-medium text-gray-600">Multi Outlet</h3>
              </th>
              <td>
                <div>
                  <svg
            ...
            <tr>
              <th scope="row" className="text-left">
                <h3 className="py-3 font-medium text-gray-600">Report Featured</h3>
              </th>
              <td>
                <div>
                  <svg
            ...
            <tr>
              <th scope="row" className="text-left">
                <h3 className="py-3 font-medium text-gray-600">Inventory Management</h3>
              </th>
              <td>
                <div>
                  <svg
            ...
            <tr>
              <th scope="row" className="text-left">
                <h3 className="py-3 font-medium text-gray-600">Direct report & teamreview</h3>
              </th>
              <td>
                <div>
                  <svg
            ...
            <tr>
              <th scope="row" className="text-left">
                <h3 className="py-3 font-medium text-gray-600">Emplovee Management System</h3>
              </th>
              <td>
                <div>
                  <svg
            ...
            <tr>
              <th scope="row" className="text-left">
                <h3 className="py-3 font-medium text-gray-600">CRM And Promotion Features</h3>
              </th>
              <td>
                <div>
                  <svg
            ...
            <tr>
              <th scope="row" className="text-left">
                <h3 className="py-3 font-medium text-gray-600">Third Party Application Integration</h3>
              </th>
              <td>
                <div>
                  <svg
